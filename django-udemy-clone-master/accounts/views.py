...
class LessonView(DetailView):
    ...
    def get_object(self, queryset=None):
        ...
        try:
            obj = queryset.get()
            # Ensure YouTube URLs are in embeddable format
            if "youtube.com/watch?v=" in obj.video_url:
                obj.video_url = obj.video_url.replace("https://www.youtube.com/watch?v=", "https://www.youtube.com/embed/")
        except queryset.model.DoesNotExist:
            raise Http404("No %(verbose_name)s found matching the query" % {'verbose_name': self.model._meta.verbose_name})
        return obj
